        ...
        <div className="flex-1 px-2 lg:flex-none">
            <div className="drawer md:hidden">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu w-50 min-h-full bg-base-200 text-base-content inline-block absolute">
            ...
            {header && (
                <a className="text-2xl font-bold text-white">{header}</a>
            )}
        </div>
        <div className="flex justify-end flex-1 px-2 ">
            <div className="flex items-stretch">
            <div className="dropdown dropdown-end">
                <label tabIndex={0} className="btn btn-ghost rounded-btn text-white">{user.user.name}</label>
