                ...
                <div className="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form onSubmit={submit} className="flex flex-col gap-3">
                        ...
                        <div>
                            ...
                            <input id="password" type="password" placeholder="Type password here" className="input input-bordered w-full max-w-xs" value={data.password} onChange={e => setData('password', e.target.value)}/>
